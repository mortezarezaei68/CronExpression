import { Component, OnInit, OnChanges, Input, EventEmitter, Output, SimpleChanges, AfterViewInit, ViewChild } from '@angular/core';
      ...
      debugger;
        ...
        switch (this.activeTab) {
            case 'minutes':
                ...
                `${this.isCronFlavorQuartz ? this.state.minutes.seconds : ''} 0/${this.state.minutes.minutes} * 1/1 * ${this.weekDayDefaultChar} ${this.yearDefaultChar}`.trim();
                break;
            case 'hourly':
                // tslint:disable-next-line: max-line-length
